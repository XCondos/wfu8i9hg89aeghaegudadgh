...
$(document).ready( function () {
    $('#landing-page').click( function () {
        ...
        const animations = [
            ...
            { selector: '#button-4', animation: 'slide-left' },
            { selector: '#button-5', animation: 'slide-up' },
            { selector: '#button-6', animation: 'slide-up' },
        ...
        new Typed('#typed-text', {
            // strings: ['Computer Science Major', 'C++ Cheat Developer', 'Languages I know..', 'C++', 'HTML', 'HTML/CSS', 'Python', 'JavaScript/TypeScript'],
            strings: ['Co-Owner @ Null', 'Null Spoofer UD', 'pawjob lover', 'paws > maws', 'known online'],
            typeSpeed: 100,
            startDelay: 3,
            backSpeed: 50,
            loop: true,
        ...
        $('#discord-tool').click( function () {
            const data = $(this).data('https://discordapp.com/users/1097401441964003328');
        ...
        $('#github-tool, #telegram-tool, #discord-tool, #guns-tool').click( function () {
